...
class ui:
    banner = f"""
             __    _  _______  _______         _______  ______    _______  _______  _______  _______  ______   
            |  |  | ||       ||       |       |       ||    _ |  |   _   ||  _    ||  _    ||       ||    _ |  
            |   |_| ||    ___||   _   | ____  |    ___||   | ||  |  |_|  || |_|   || |_|   ||    ___||   | ||  
            |       ||   |___ |  | |  ||____| |   | __ |   |_||_ |       ||       ||       ||   |___ |   |_||_ 
            |  _    ||    ___||  |_|  |       |   ||  ||    __  ||       ||  _   | |  _   | |    ___||    __  |
            | | |   ||   |___ |       |       |   |_| ||   |  | ||   _   || |_|   || |_|   ||   |___ |   |  | |
            |_|  |__||_______||_______|       |_______||___|  |_||__| |__||_______||_______||_______||___|  |_|
